...
//obiekt desktopViewport
const desktopViewport = window.matchMedia("(min-width: 500px)");

console.log(desktopViewport)
...
desktopViewport.addEventListener('change', drawValues)
